print("=" * 68)
print("EGX WEEKLY SIMPLE PULLBACK BACKTEST v6.0")
...
def backtest_symbol(symbol, df):
    ...
    for i in range(len(df)):
        ...
        # Activate after +6%.
        #
        # Then protect 5% below the highest price.
        # ======================================================
        ...
        if low <= stop_price:
            ...
            # --------------------------------------------------
            # Keep the same accounting convention as the
            # previous backtest:
            #
